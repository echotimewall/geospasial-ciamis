...
if(isset($_POST['submit'])){
    ...
    if ($_SESSION["code"] != $_POST["kdcaptcha"]) {
        echo '<script>alert("Kode Captcha salah !");history.go(-1);</script>';        
    } else {
            ...
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    <div class="row">
                        ...
                        <div class="col-md-2">
							<h6 style="margin-top: 33px; font-weight: bold;">Sign In</h6>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <div class="row px-3">
                        ...
                        <input type="text" name="kdcaptcha" placeholder="Enter captcha">
