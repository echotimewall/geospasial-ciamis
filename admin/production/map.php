...
<body class="calcite-maps calcite-nav-top">
  ...
  <nav class="navbar calcite-navbar navbar-fixed-top calcite-text-light calcite-bg-dark calcite-bgcolor-dark-blue">
    ...
    <div class="calcite-title calcite-overflow-hidden">
      ...
      <span class="calcite-title-sub hidden-xs"><label id="lblKoordinat"></label></span>
    </div>
    <!-- Nav -->
    <ul class="nav navbar-nav calcite-nav">
      ...
      <li>
        <!--<div class="calcite-navbar-search calcite-search-expander"></div>-->
            <label style="color: white;"><?php echo $_SESSION['admin']['Name']; ?></label>&nbsp;
          <span class="calcite-title-main" style="margin-right: 5px;">
            <img src="images/user.png" style="width: 40px; height: 40px; margin-top: 5px;">
          </span>
      </li>
    </ul>
  </nav>
