...
<html lang="en">
  <head>
    ...
    <title>Users | Database Pembangunan Wilayah Kabupaten Ciamis</title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><small>Daftar Pengguna</small> Geospatial Ciamis</h2>        
                    <div class="nav navbar-right panel_toolbox">
                      <a href="frm_users.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> User Baru</a>
                    </div>                 
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
