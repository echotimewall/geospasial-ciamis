...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><small>Daftar </small>Air Minum</h2>         
                    <div class="nav navbar-right panel_toolbox">
                      <a href="frm_air.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Data Baru</a>
                    </div>           
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
   ...
   <script src="../vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="js/get_air.js"></script>
