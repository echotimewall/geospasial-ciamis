...
<html lang="en">
  <head>
    ...
    <title>Saluran Irigasi | Database Pembangunan Wilayah Kabupaten Ciamis</title>
  ...
  <body class="nav-md">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><small>Daftar </small>Saluran Irigasi Detail D.I Danasari Kiri</h2>         
   ...
   <script src="../vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="js/get_dankir_irigasi.js"></script>
